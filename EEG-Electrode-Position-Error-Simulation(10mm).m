% This code simulates 10 mm Gaussian noise perturbations on EEG electrode positions, 
...
title('Error Due to Electrode Position Change 10mm (100 Iterations)');
grid on;
