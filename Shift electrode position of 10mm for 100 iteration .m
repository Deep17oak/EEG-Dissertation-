% Standard deviation of 10 mm for 100 iterations: shift electrode positions, project to scalp surface, average error vs original.
...
for i = 1:100
    perturbedEl = El + 0.005 * randn(size(El));  % Add 10 mm std dev noise
